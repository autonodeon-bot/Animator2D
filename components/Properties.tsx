...
export const Properties: React.FC<PropertiesProps> = ({ 
  ...
  if (selection.type === 'SPRITE') {
      ...
      const swapImage = (url: string) => { updateSprite(sprite.id, { imageUrl: url }); };
            ...
            <div className="p-4 space-y-6">
                ...
                <div className="space-y-3">
                    ...
                    <div className="flex gap-1 justify-center py-2">
                        <button onClick={() => updateSprite(sprite.id, { offsetX: 0 })} className="p-1 bg-neutral-700 rounded hover:bg-neutral-600" title="Align Center X"><AlignCenterHorizontal size={14}/></button>
                        <button onClick={() => updateSprite(sprite.id, { offsetY: 0 })} className="p-1 bg-neutral-700 rounded hover:bg-neutral-600" title="Align Center Y"><AlignCenterVertical size={14}/></button>
                        <div className="w-px bg-neutral-600 mx-1"></div>
                        <button onClick={() => updateSprite(sprite.id, { scaleX: sprite.scaleX * -1 })} className="p-1 bg-neutral-700 rounded hover:bg-neutral-600" title="Flip Horizontal"><ArrowLeftRight size={14}/></button>
                        <button onClick={() => updateSprite(sprite.id, { scaleY: sprite.scaleY * -1 })} className="p-1 bg-neutral-700 rounded hover:bg-neutral-600" title="Flip Vertical"><ArrowUpDown size={14}/></button>
                    </div>
